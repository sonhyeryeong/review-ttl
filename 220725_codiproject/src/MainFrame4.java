...
public class MainFrame4 extends JFrame{
	public MainFrame4() {
		...
		JLabel lbl1 = new JLabel("큰 게시글");
		leftPnl.setBorder(new LineBorder(Color.CYAN,2));
		leftPnl.add(lbl1);
		...
		rightPnl.setLayout(new GridLayout(2,0));
		//top3 부분
		...
		middlePnl.add(leftPnl);
		middlePnl.add(rightPnl);
		middlePnl.setLayout(new GridLayout(0,2));
		////////중간 부분 끝
